...
public class MotoristaService extends BaseService<Integer, Motorista>{
	...
	public List<Motorista> findMotoristasServidores(String ugid) {
		return executeResultListQuery("findServidor", ugid);
	}
	...
	public List<Motorista> findByLocadoraUg(UG ug) {
		return executeResultListQuery("findByLocadoraUg", "LOCADORA", ug.getId());
	}
