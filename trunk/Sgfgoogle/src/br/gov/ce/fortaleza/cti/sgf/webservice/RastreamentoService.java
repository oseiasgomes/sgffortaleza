...
public class RastreamentoService {
	...
	private static final Log logger = LogFactory.getLog(RastreamentoService.class);
	...
	private RastreamentoService() {
		client = new HttpClient();
		client.getHostConfiguration().setHost("174.142.214.78", 80, "http");
	}

	public static RastreamentoService login() {

		RastreamentoService connection = new RastreamentoService();
		StringBuffer xml = new StringBuffer(XmlUtil.XML_HEADER);
		xml.append("<USER>");
		xml.append("<LOGIN>checkrota1</LOGIN>");
		xml.append("<PASSWORD>checkrota2007</PASSWORD>");
	...
	public static RastreamentoService loginMaxTrack() {
	...
	public void bloquearMaisSireneVeiculo(Veiculo veiculo) {
	...
	public void bloquearMaisSireneVeiculo(Integer codigoExternoVeiculo) {
	...
	public void desbloquearMaisSireneVeiculo(Integer codigoExternoVeiculo) {
